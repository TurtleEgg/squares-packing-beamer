...
\begin{tikzpicture}[x=0.800cm,y=0.800cm]
  ...
  % выносная линия от верха этой упаковки; зазор показан увеличенным
  \draw[black,line width=0.4pt] (4.70711,4.70711) -- (5.00711,4.90711) -- (5.83211,4.90711);
  % размерная линия на уровне стороны упаковки Бидвелла
  \draw[red,line width=0.8pt] (4.70711,4.67553) -- (5.83211,4.67553);
  \draw[black,line width=0.45pt,-{Stealth[length=1.8mm]}] (5.35961,5.22711) -- (5.35961,4.90711);
  \draw[black,line width=0.45pt,-{Stealth[length=1.8mm]}] (5.35961,4.35553) -- (5.35961,4.67553);
\end{tikzpicture}
\end{document}
