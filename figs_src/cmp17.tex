...
\begin{tikzpicture}[x=0.800cm,y=0.800cm]
  ...
  \draw[red,line width=0.7pt] (4.70711,4.74961) -- (5.55086,4.74961);
  % выносная линия от ПРАВОЙ схемы: три четверти промежутка, левой схемы не касается
  \draw[red,line width=0.7pt] (5.83211,4.63303) -- (4.98836,4.63303);
  \draw[black,line width=0.45pt,-{Stealth[length=1.8mm]}] (5.26961,5.22711) -- (5.26961,4.74961);
  \draw[black,line width=0.45pt,-{Stealth[length=1.8mm]}] (5.26961,4.35553) -- (5.26961,4.63303);
\end{tikzpicture}
\end{document}
